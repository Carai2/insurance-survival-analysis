...
# Save plots
ggsave("/home/claude/km_overall.png", plot = p1$plot, width = 10, height = 6, dpi = 300)
ggsave("/home/claude/km_age.png", plot = p2$plot, width = 10, height = 8, dpi = 300)
ggsave("/home/claude/km_smoker.png", plot = p3$plot, width = 10, height = 8, dpi = 300)
ggsave("/home/claude/km_policy_type.png", plot = p4$plot, width = 10, height = 8, dpi = 300)

if(exists("p5")) {
  ggsave("/home/claude/hazard_ratios.png", plot = p5, width = 10, height = 6, dpi = 300)
}

ggsave("/home/claude/parametric_survival.png", plot = p6, width = 10, height = 6, dpi = 300)
...
# Save dataset
write.csv(insurance_data, "/home/claude/insurance_survival_data.csv", row.names = FALSE)

# Save model results
sink("/home/claude/model_results.txt")
